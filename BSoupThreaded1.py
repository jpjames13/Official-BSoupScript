...
def main():
    ...
    #creating thread tasks for classes about and sdk
    for files in file_path_:
        thread1 = threading.Thread(target=about,args=(file_path_,))
        thread2 = threading.Thread(target=sdk,args=(file_path_,))
    #starting the thread tasks 1 & 2 and then appending to threads list
        thread1.start()
        thread2.start()
        threads.append(thread1)
        threads.appends(thread2)
